...
function customAssign(...objects) {
  if (objects.length <= 2) {
    ...
    for (let i in obj) {
      typeof obj[i] === "number" ? obj[i] = obj[i].toString() : obj[i];
    };
    return obj
  }
...
function customEntries(obj) {
  return typeof obj === "object" ? Object.entries(obj) : "Помилка: Аргумент не є об'єктом.";
...
function customObjectFromEntries(entries) {
  ...
  return Array.isArray(entries) ? ar(entries) : "Помилка: Вхідний аргумент має бути масивом." ;
...
console.log(Object.fromEntries([[23, "hello"]]));
...
function checkProperty(obj, prop) {
  return typeof obj !== "object" && typeof prop !== "string" ? false : obj.hasOwnProperty(prop);
...
function extendAndFreezeObject(obj1, obj2) {
  function FreezeObj(obj1, obj2) {
    Object.assign(obj1 , obj2);
    Object.freeze(obj1);
    return Object.isFrozen(obj1) ? obj1 : "Problem"
  };
  return typeof obj1 !== "object" && typeof obj2 !== "object" ? null : FreezeObj(obj1, obj2);
...
function keysAndValues(obj) {
  ...
  return typeof obj === "object" ? objKeys(obj) : null;
...
function filterObjectsByKey(arr, key) {
  ...
  return Array.isArray(arr) ? filterArr(arr, key) : [];
...
function checkAndPreventExtensions(obj) {
  ...
  return typeof obj === "object" ? prevExt(obj) : false;
...
function sealAndCheck(obj) {
  function sac(obj) {
    Object.seal(obj);
    return Object.isSealed(obj) ? true : false;
  }
  return typeof obj === "object" ? sac(obj) : false;
  // Перевіряємо, чи вхідний параметр є об'єктом, якщо ні, повертаємо false
...
function checkOwnership(obj1, obj2, key) {
  return obj1.hasOwnProperty(key) && obj2.hasOwnProperty(key) ? obj1.hasOwnProperty(key) === obj2.hasOwnProperty(key) ? true : false : false
...
function getObjectValuesSum(obj) {
  function val(obj) {
    let values = Object.values(obj);
    return values.reduce((acum, elem) => acum += elem)
  }
  return typeof obj === "object" ? val(obj) : 0;
...
function convertArrayToObj(arr) {
  function toObj(arr) {
    ...
    for (let i = 0 ; i < arr.length; i++) {
      let [a , b] = arr[i];
      obj1.hasOwnProperty(a) ? console.log(`У масиві є дубльований ключ: ${a}`) : arr[i] = [a, b]
    }
    return obj1 = Object.fromEntries(arr)
  };
  return Array.isArray(arr) ? toObj(arr) : {} ;
